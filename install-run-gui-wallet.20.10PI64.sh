...
mkdir ~/Hydra
pushd ~/Hydra
wget -N https://github.com/Hydra-Chain/node/releases/download/hydra_v0.18.5.3/hydra-0.18.5.3-aarch64-linux-gnu.zip
unzip -o hydra-0.18.5.3-aarch64-linux-gnu.zip
mkdir ~/.hydra
